...
export const Navbar = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <header style={{
      ...
      {/* Top Telemetry & Status Bar (Desktop) */}
      <div className="desktop-nav-header" style={{
        display: 'flex',
        alignItems: 'center',
      ...
      {/* 2. MOBILE / TABLET HEADER (Screens <= 900px) */}
      ...
      {/* 3. DESKTOP NAVIGATION TABS (Hidden on mobile/tablet) */}
